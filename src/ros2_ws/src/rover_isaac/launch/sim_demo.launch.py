...
launch_args = [
    ...
    DeclareLaunchArgument('gui', default_value='/home/ubuntu/jaops/jaops-sim/scenes/lunar_surface_demo_ros2.usd', description='Provide the path to a usd file to open it when starting Isaac Sim in standard gui mode. If left empty, Isaac Sim will open an empty stage in standard gui mode.'),
